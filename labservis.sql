...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 08 2018 г., 15:49
...
(21, 3, 'ООП и ПП', 'ель работы: показать знания и умения писать простые программы, используя разные парадигмы программирования. Попрактиковаться в создании интерфейсов.\r\nВремя выполнения: 8 часов\r\n', '', 0, 9),
